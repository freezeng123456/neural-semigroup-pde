...
def test_model_budget_and_bounded_latent_output():
    ...
    decoded_energy_output = build_model(
        "latent_decoded_energy", _tiny_args(Path("/tmp"))
    )(u, 0.02)
    ...
    physics_output = build_model(
        "latent_physics_anchored_periodic", _tiny_args(Path("/tmp"))
    )(u, 0.02)
